...
embryos = 5000 %embryoSize;  % Here you could just change the number of embryos you would 
...
x_scaled = (0:0.02:1)';
dpp_matrix = zeros(51,embryos);
dpp_noise_matrix = zeros(51,embryos);
dpp_extr_matrix = zeros(51,embryos);
dpp_extr_matrix2 = zeros(51,embryos);
dpp_int_matrix = zeros(51,embryos);
